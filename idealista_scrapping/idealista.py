...
def parse_html_file(file_path):
    ...
    for listing in listings:
        ...
        area_text = listing.find('span', class_='item-detail').get_text(strip=True) if listing.find('span', class_='item-detail') else '0 m²'
        address = listing.find('span', class_='item-address').get_text(strip=True) if listing.find('span', class_='item-address') else 'No address'
...
data1 = parse_html_file('Viviendas venta. Viviendas alquiler. Pisos. Chalets — idealista.htm')
data2 = parse_html_file('Viviendas venta. Viviendas alquiler. Pisos. Chalets — idealista 2.htm')
data3 = parse_html_file('Viviendas venta. Viviendas alquiler. Pisos. Chalets — idealista 3.htm')
data4 = parse_html_file('Viviendas venta. Viviendas alquiler. Pisos. Chalets — idealista 4.htm')
data5 = parse_html_file('Viviendas venta. Viviendas alquiler. Pisos. Chalets — idealista 5.htm')
